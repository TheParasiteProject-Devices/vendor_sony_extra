...
# DTS:X Path
LOCAL_DTSX := $(EXTRA_PATH)/extra/audio/dtsx
...
# SEPolicy
BOARD_VENDOR_SEPOLICY_DIRS += $(LOCAL_DTSX)/sepolicy/vendor
...
# DTS:X Config(s)
PRODUCT_COPY_FILES += \
    $(call find-copy-subdir-files,*,$(LOCAL_DTSX)/configs/perms,$(TARGET_COPY_OUT_SYSTEM)/etc) \
    $(call find-copy-subdir-files,*,$(LOCAL_DTSX)/configs/dts,$(TARGET_COPY_OUT_VENDOR)/etc)
