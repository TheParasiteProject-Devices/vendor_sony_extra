...
.method public a(IIII)Landroid/view/View;
    ...
    invoke-interface {v0}, Landroidx/recyclerview/widget/b0$b;->c()I
    ...
    invoke-interface {v4, p1}, Landroidx/recyclerview/widget/b0$b;->a(I)Landroid/view/View;

    move-result-object v4

    iget-object v5, p0, Landroidx/recyclerview/widget/b0;->a:Landroidx/recyclerview/widget/b0$b;

    invoke-interface {v5, v4}, Landroidx/recyclerview/widget/b0$b;->e(Landroid/view/View;)I

    move-result v5

    iget-object v6, p0, Landroidx/recyclerview/widget/b0;->a:Landroidx/recyclerview/widget/b0$b;

    invoke-interface {v6, v4}, Landroidx/recyclerview/widget/b0$b;->d(Landroid/view/View;)I
...
.method public b(Landroid/view/View;I)Z
    ...
    invoke-interface {v1}, Landroidx/recyclerview/widget/b0$b;->c()I

    move-result v1

    iget-object v2, p0, Landroidx/recyclerview/widget/b0;->a:Landroidx/recyclerview/widget/b0$b;

    invoke-interface {v2}, Landroidx/recyclerview/widget/b0$b;->b()I

    move-result v2

    iget-object v3, p0, Landroidx/recyclerview/widget/b0;->a:Landroidx/recyclerview/widget/b0$b;

    invoke-interface {v3, p1}, Landroidx/recyclerview/widget/b0$b;->e(Landroid/view/View;)I

    move-result v3

    iget-object v4, p0, Landroidx/recyclerview/widget/b0;->a:Landroidx/recyclerview/widget/b0$b;

    invoke-interface {v4, p1}, Landroidx/recyclerview/widget/b0$b;->d(Landroid/view/View;)I
    ...
    .line 2
    iget-object p0, p0, Landroidx/recyclerview/widget/b0;->b:Landroidx/recyclerview/widget/b0$a;

    .line 3
    iput p1, p0, Landroidx/recyclerview/widget/b0$a;->a:I
    ...
    .line 5
    invoke-virtual {p0}, Landroidx/recyclerview/widget/b0$a;->a()Z
