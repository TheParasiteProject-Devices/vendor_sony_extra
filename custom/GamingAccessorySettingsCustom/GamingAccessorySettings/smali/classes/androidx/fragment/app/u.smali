...
.method public static a(Landroid/content/Context;Landroidx/fragment/app/n;ZZ)Landroidx/fragment/app/u$a;
    ...
    iget-object v2, p1, Landroidx/fragment/app/n;->K:Landroid/view/ViewGroup;

    const/4 v3, 0x0

    if-eqz v2, :cond_4

    const v4, 0x7f0801aa    # @id/visible_removing_fragment_view_tag
    ...
    :cond_4
    iget-object p1, p1, Landroidx/fragment/app/n;->K:Landroid/view/ViewGroup;
    ...
    const p1, 0x7f020003    # @animator/fragment_close_enter 'res/animator/fragment_close_enter.xml'

    goto :goto_2

    :cond_7
    const p1, 0x7f020004    # @animator/fragment_close_exit 'res/animator/fragment_close_exit.xml'
    ...
    const p1, 0x7f020005    # @animator/fragment_fade_enter 'res/animator/fragment_fade_enter.xml'

    goto :goto_2

    :cond_9
    const p1, 0x7f020006    # @animator/fragment_fade_exit 'res/animator/fragment_fade_exit.xml'
    ...
    const p1, 0x7f020007    # @animator/fragment_open_enter 'res/animator/fragment_open_enter.xml'

    goto :goto_2

    :cond_b
    const p1, 0x7f020008    # @animator/fragment_open_exit 'res/animator/fragment_open_exit.xml'
