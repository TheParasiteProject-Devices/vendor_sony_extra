...
.method public constructor <init>(Landroidx/emoji2/text/g;)V
    ...
    iput-object v0, p0, Landroidx/emoji2/text/i;->h:Landroid/graphics/Paint$FontMetricsInt;

    const/4 v0, -0x1

    iput-short v0, p0, Landroidx/emoji2/text/i;->j:S
    ...
    iput-object p1, p0, Landroidx/emoji2/text/i;->i:Landroidx/emoji2/text/g;
...
.method public getSize(Landroid/graphics/Paint;Ljava/lang/CharSequence;IILandroid/graphics/Paint$FontMetricsInt;)I
    ...
    iget-object p2, p0, Landroidx/emoji2/text/i;->h:Landroid/graphics/Paint$FontMetricsInt;

    invoke-virtual {p1, p2}, Landroid/graphics/Paint;->getFontMetricsInt(Landroid/graphics/Paint$FontMetricsInt;)I

    iget-object p1, p0, Landroidx/emoji2/text/i;->h:Landroid/graphics/Paint$FontMetricsInt;
    ...
    iget-object p2, p0, Landroidx/emoji2/text/i;->i:Landroidx/emoji2/text/g;
    ...
    iget-object p1, p0, Landroidx/emoji2/text/i;->i:Landroidx/emoji2/text/g;
    ...
    .line 1
    invoke-virtual {p1}, Landroidx/emoji2/text/g;->e()Lm3/a;
    ...
    .line 2
    invoke-virtual {p1, p2}, Lm3/c;->a(I)I

    move-result p2

    if-eqz p2, :cond_0

    iget-object p3, p1, Lm3/c;->b:Ljava/nio/ByteBuffer;

    iget p1, p1, Lm3/c;->a:I
    ...
    iput-short p1, p0, Landroidx/emoji2/text/i;->j:S

    if-eqz p5, :cond_1

    iget-object p0, p0, Landroidx/emoji2/text/i;->h:Landroid/graphics/Paint$FontMetricsInt;
