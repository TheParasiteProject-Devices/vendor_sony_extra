...
.method public a(Lcom/google/android/material/textfield/TextInputLayout;)V
    ...
    .line 1
    iget-object v2, v1, Le5/k;->a:Lcom/google/android/material/textfield/TextInputLayout;
    ...
    iget-object v1, v1, Lcom/google/android/material/textfield/b;->n:Lb5/f;
    ...
    iget-object v6, v1, Le5/k;->a:Lcom/google/android/material/textfield/TextInputLayout;

    invoke-virtual {v6}, Lcom/google/android/material/textfield/TextInputLayout;->getBoxBackground()Lb5/f;

    move-result-object v6

    const v7, 0x7f0300c8    # @attr/colorControlHighlight

    invoke-static {v0, v7}, Ll1/x;->s(Landroid/view/View;I)I
    ...
    const v10, 0x10100a7    # @android:attr/state_pressed
    ...
    .line 6
    invoke-static {v0, v1}, Ll1/x;->s(Landroid/view/View;I)I
    ...
    .line 7
    iget-object v10, v6, Lb5/f;->h:Lb5/f$b;

    iget-object v10, v10, Lb5/f$b;->a:Lb5/i;

    .line 8
    invoke-direct {v2, v10}, Lb5/f;-><init>(Lb5/i;)V

    invoke-static {v7, v1, v9}, Ll1/x;->v(IIF)I
    ...
    invoke-virtual {v2, v10}, Lb5/f;->q(Landroid/content/res/ColorStateList;)V

    invoke-virtual {v2, v1}, Lb5/f;->setTint(I)V
    ...
    .line 9
    iget-object v8, v6, Lb5/f;->h:Lb5/f$b;

    iget-object v8, v8, Lb5/f$b;->a:Lb5/i;

    .line 10
    invoke-direct {v7, v8}, Lb5/f;-><init>(Lb5/i;)V

    const/4 v8, -0x1

    invoke-virtual {v7, v8}, Lb5/f;->setTint(I)V
    ...
    .line 11
    invoke-static {v0, v2}, Lz2/s$d;->q(Landroid/view/View;Landroid/graphics/drawable/Drawable;)V
    ...
    .line 12
    iget-object v1, v1, Le5/k;->a:Lcom/google/android/material/textfield/TextInputLayout;
    ...
    invoke-direct {v2, v1, v0}, Le5/h;-><init>(Lcom/google/android/material/textfield/b;Landroid/widget/AutoCompleteTextView;)V
    ...
    invoke-direct {v2, v1}, Le5/i;-><init>(Lcom/google/android/material/textfield/b;)V
    ...
    iget-object v0, v0, Le5/k;->c:Lcom/google/android/material/internal/CheckableImageButton;

    sget-object v1, Lz2/s;->a:Ljava/util/WeakHashMap;

    .line 24
    invoke-static {v0, v3}, Lz2/s$d;->s(Landroid/view/View;I)V

    .line 25
    :cond_7
    iget-object p0, p0, Lcom/google/android/material/textfield/b$d;->a:Lcom/google/android/material/textfield/b;
