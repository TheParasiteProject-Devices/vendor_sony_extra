...
.method public u(Landroid/view/View;Landroid/view/View;ZZ)Landroid/animation/AnimatorSet;
    ...
    .line 2
    invoke-static/range {p2 .. p2}, Lz2/s$i;->i(Landroid/view/View;)F

    move-result v7

    invoke-static/range {p1 .. p1}, Lz2/s$i;->i(Landroid/view/View;)F
    ...
    :goto_0
    iget-object v11, v4, Lcom/google/android/material/transformation/FabTransformationBehavior$b;->a:Lh4/g;

    const-string v12, "elevation"

    invoke-virtual {v11, v12}, Lh4/g;->d(Ljava/lang/String;)Lh4/h;

    move-result-object v11

    invoke-virtual {v11, v7}, Lh4/h;->a(Landroid/animation/Animator;)V
    ...
    .line 5
    iget-object v11, v4, Lcom/google/android/material/transformation/FabTransformationBehavior$b;->b:Lc1/b;

    invoke-virtual {v0, v1, v2, v11}, Lcom/google/android/material/transformation/FabTransformationBehavior;->w(Landroid/view/View;Landroid/view/View;Lc1/b;)F

    move-result v11

    iget-object v12, v4, Lcom/google/android/material/transformation/FabTransformationBehavior$b;->b:Lc1/b;

    invoke-virtual {v0, v1, v2, v12}, Lcom/google/android/material/transformation/FabTransformationBehavior;->x(Landroid/view/View;Landroid/view/View;Lc1/b;)F
    ...
    check-cast v14, Lh4/h;

    iget-object v13, v13, Landroid/util/Pair;->second:Ljava/lang/Object;

    check-cast v13, Lh4/h;
    ...
    .line 6
    invoke-virtual {v0, v4, v14, v11, v8}, Lcom/google/android/material/transformation/FabTransformationBehavior;->y(Lcom/google/android/material/transformation/FabTransformationBehavior$b;Lh4/h;FF)F

    move-result v11

    invoke-virtual {v0, v4, v13, v12, v8}, Lcom/google/android/material/transformation/FabTransformationBehavior;->y(Lcom/google/android/material/transformation/FabTransformationBehavior$b;Lh4/h;FF)F
    ...
    :goto_1
    invoke-virtual {v14, v6}, Lh4/h;->a(Landroid/animation/Animator;)V

    invoke-virtual {v13, v8}, Lh4/h;->a(Landroid/animation/Animator;)V
    ...
    .line 9
    iget-object v8, v4, Lcom/google/android/material/transformation/FabTransformationBehavior$b;->b:Lc1/b;

    invoke-virtual {v0, v1, v2, v8}, Lcom/google/android/material/transformation/FabTransformationBehavior;->w(Landroid/view/View;Landroid/view/View;Lc1/b;)F

    move-result v8

    iget-object v11, v4, Lcom/google/android/material/transformation/FabTransformationBehavior$b;->b:Lc1/b;

    invoke-virtual {v0, v1, v2, v11}, Lcom/google/android/material/transformation/FabTransformationBehavior;->x(Landroid/view/View;Landroid/view/View;Lc1/b;)F
    ...
    invoke-virtual {v12, v11}, Lh4/h;->a(Landroid/animation/Animator;)V
    ...
    :cond_9
    sget-object v13, Lh4/d;->a:Landroid/util/Property;
    ...
    :cond_a
    sget-object v14, Lh4/d;->a:Landroid/util/Property;
    ...
    iget-object v14, v4, Lcom/google/android/material/transformation/FabTransformationBehavior$b;->a:Lh4/g;

    const-string v15, "iconFade"

    invoke-virtual {v14, v15}, Lh4/g;->d(Ljava/lang/String;)Lh4/h;

    move-result-object v14

    invoke-virtual {v14, v13}, Lh4/h;->a(Landroid/animation/Animator;)V

    invoke-virtual {v5, v13}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    new-instance v13, Lcom/google/android/material/transformation/b;

    invoke-direct {v13, v0, v11, v12}, Lcom/google/android/material/transformation/b;-><init>(Lcom/google/android/material/transformation/FabTransformationBehavior;Lp4/d;Landroid/graphics/drawable/Drawable;)V
    ...
    check-cast v12, Lp4/d;

    iget-object v13, v4, Lcom/google/android/material/transformation/FabTransformationBehavior$b;->b:Lc1/b;
    ...
    invoke-virtual {v0, v1, v2, v13}, Lcom/google/android/material/transformation/FabTransformationBehavior;->w(Landroid/view/View;Landroid/view/View;Lc1/b;)F
    ...
    .line 15
    iget-object v10, v4, Lcom/google/android/material/transformation/FabTransformationBehavior$b;->b:Lc1/b;
    ...
    invoke-virtual {v0, v1, v2, v10}, Lcom/google/android/material/transformation/FabTransformationBehavior;->x(Landroid/view/View;Landroid/view/View;Lc1/b;)F
    ...
    iget-object v13, v4, Lcom/google/android/material/transformation/FabTransformationBehavior$b;->a:Lh4/g;

    const-string v14, "expansion"

    invoke-virtual {v13, v14}, Lh4/g;->d(Ljava/lang/String;)Lh4/h;
    ...
    new-instance v14, Lp4/d$e;

    invoke-direct {v14, v9, v8, v10}, Lp4/d$e;-><init>(FFF)V

    invoke-interface {v12, v14}, Lp4/d;->setRevealInfo(Lp4/d$e;)V

    :cond_d
    if-eqz p4, :cond_e

    invoke-interface {v12}, Lp4/d;->getRevealInfo()Lp4/d$e;

    move-result-object v10

    iget v10, v10, Lp4/d$e;->c:F

    :cond_e
    const/4 v14, 0x0

    .line 20
    invoke-static {v9, v8, v14, v14}, Ll1/x;->n(FFFF)F

    move-result v15

    invoke-static {v9, v8, v6, v14}, Ll1/x;->n(FFFF)F

    move-result v21

    invoke-static {v9, v8, v6, v7}, Ll1/x;->n(FFFF)F

    move-result v6

    invoke-static {v9, v8, v14, v7}, Ll1/x;->n(FFFF)F
    ...
    .line 21
    :goto_7
    invoke-static {v12, v9, v8, v15}, Lp4/b;->a(Lp4/d;FFF)Landroid/animation/Animator;

    move-result-object v6

    new-instance v7, Lcom/google/android/material/transformation/c;

    invoke-direct {v7, v0, v12}, Lcom/google/android/material/transformation/c;-><init>(Lcom/google/android/material/transformation/FabTransformationBehavior;Lp4/d;)V

    invoke-virtual {v6, v7}, Landroid/animation/Animator;->addListener(Landroid/animation/Animator$AnimatorListener;)V

    .line 22
    iget-wide v14, v13, Lh4/h;->a:J
    ...
    iget v0, v0, Lp4/d$e;->c:F

    invoke-static {v12, v9, v8, v10}, Lp4/b;->a(Lp4/d;FFF)Landroid/animation/Animator;
    ...
    .line 28
    iget-wide v8, v13, Lh4/h;->b:J

    .line 29
    iget-object v0, v4, Lcom/google/android/material/transformation/FabTransformationBehavior$b;->a:Lh4/g;

    move-object/from16 v21, v6

    .line 30
    iget-object v6, v0, Lh4/g;->a:Lm/g;
    ...
    invoke-virtual {v6, v11}, Lm/g;->m(I)Ljava/lang/Object;
    ...
    .line 33
    iget-wide v12, v6, Lh4/h;->a:J

    move-object/from16 v25, v5

    .line 34
    iget-wide v5, v6, Lh4/h;->b:J
    ...
    .line 37
    :goto_a
    invoke-virtual {v0, v6}, Lh4/h;->a(Landroid/animation/Animator;)V
    ...
    invoke-direct {v0, v3}, Lp4/a;-><init>(Lp4/d;)V
    ...
    .line 42
    invoke-static/range {p1 .. p1}, Lz2/s$i;->g(Landroid/view/View;)Landroid/content/res/ColorStateList;
    ...
    .line 44
    invoke-interface {v0, v4}, Lp4/d;->setCircularRevealScrimColor(I)V

    :cond_19
    sget-object v4, Lp4/d$d;->a:Landroid/util/Property;
    ...
    sget-object v5, Lp4/d$d;->a:Landroid/util/Property;
    ...
    iget-object v5, v4, Lcom/google/android/material/transformation/FabTransformationBehavior$b;->a:Lh4/g;

    const-string v7, "color"

    invoke-virtual {v5, v7}, Lh4/g;->d(Ljava/lang/String;)Lh4/h;

    move-result-object v5

    invoke-virtual {v5, v0}, Lh4/h;->a(Landroid/animation/Animator;)V
    ...
    :cond_1b
    const v0, 0x7f0800fa    # @id/mtrl_child_content_container
    ...
    :cond_1c
    instance-of v0, v2, Lg5/b;

    if-nez v0, :cond_1e

    instance-of v0, v2, Lg5/a;
    ...
    .line 47
    sget-object v7, Lh4/c;->a:Landroid/util/Property;
    ...
    :goto_13
    iget-object v4, v4, Lcom/google/android/material/transformation/FabTransformationBehavior$b;->a:Lh4/g;

    const-string v7, "contentFade"

    invoke-virtual {v4, v7}, Lh4/g;->d(Ljava/lang/String;)Lh4/h;

    move-result-object v4

    invoke-virtual {v4, v0}, Lh4/h;->a(Landroid/animation/Animator;)V
    ...
    invoke-static {v0, v1}, Lc5/a;->I(Landroid/animation/AnimatorSet;Ljava/util/List;)V
...
.method public final v(FFZLcom/google/android/material/transformation/FabTransformationBehavior$b;)Landroid/util/Pair;
    ...
    :cond_2
    iget-object p0, p4, Lcom/google/android/material/transformation/FabTransformationBehavior$b;->a:Lh4/g;

    const-string p1, "translationXCurveUpwards"

    invoke-virtual {p0, p1}, Lh4/g;->d(Ljava/lang/String;)Lh4/h;

    move-result-object p0

    iget-object p1, p4, Lcom/google/android/material/transformation/FabTransformationBehavior$b;->a:Lh4/g;
    ...
    :goto_1
    invoke-virtual {p1, p2}, Lh4/g;->d(Ljava/lang/String;)Lh4/h;
...
.method public final w(Landroid/view/View;Landroid/view/View;Lc1/b;)F
    .locals 3
...
.method public final x(Landroid/view/View;Landroid/view/View;Lc1/b;)F
    .locals 3
...
.method public final y(Lcom/google/android/material/transformation/FabTransformationBehavior$b;Lh4/h;FF)F
    .locals 6

    .line 1
    iget-wide v0, p2, Lh4/h;->a:J

    .line 2
    iget-wide v2, p2, Lh4/h;->b:J

    .line 3
    iget-object p0, p1, Lcom/google/android/material/transformation/FabTransformationBehavior$b;->a:Lh4/g;
    ...
    .line 4
    iget-wide v4, p0, Lh4/h;->a:J

    .line 5
    iget-wide p0, p0, Lh4/h;->b:J
    ...
    .line 6
    invoke-virtual {p2}, Lh4/h;->b()Landroid/animation/TimeInterpolator;
    ...
    invoke-static {p3, p4, p0}, Lh4/a;->a(FFF)F
