...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    const v0, 0x7f0f03f9    # @style/Widget.MaterialComponents.Toolbar

    const v1, 0x7f0303d0    # @attr/toolbarStyle
    ...
    sget-object v4, Lg4/a;->u:[I

    const/4 v0, 0x0

    new-array v7, v0, [I

    const v6, 0x7f0f03f9    # @style/Widget.MaterialComponents.Toolbar

    const v5, 0x7f0303d0    # @attr/toolbarStyle
    ...
    invoke-virtual {v1, p2}, Lb5/f;->q(Landroid/content/res/ColorStateList;)V

    .line 3
    iget-object p2, v1, Lb5/f;->h:Lb5/f$b;

    new-instance v0, Lt4/a;

    invoke-direct {v0, p1}, Lt4/a;-><init>(Landroid/content/Context;)V

    iput-object v0, p2, Lb5/f$b;->b:Lt4/a;

    invoke-virtual {v1}, Lb5/f;->x()V

    .line 4
    sget-object p1, Lz2/s;->a:Ljava/util/WeakHashMap;

    .line 5
    invoke-static {p0}, Lz2/s$i;->i(Landroid/view/View;)F

    move-result p1

    .line 6
    invoke-virtual {v1, p1}, Lb5/f;->p(F)V

    .line 7
    invoke-static {p0, v1}, Lz2/s$d;->q(Landroid/view/View;Landroid/graphics/drawable/Drawable;)V
...
.method public onLayout(ZIIII)V
    ...
    invoke-static {p0, p1}, Lc5/a;->w(Landroidx/appcompat/widget/Toolbar;Ljava/lang/CharSequence;)Landroid/widget/TextView;
    ...
    invoke-static {p0, p2}, Lc5/a;->w(Landroidx/appcompat/widget/Toolbar;Ljava/lang/CharSequence;)Landroid/widget/TextView;
    ...
    .line 5
    iget-boolean p3, p0, Lcom/google/android/material/appbar/MaterialToolbar;->a0:Z
