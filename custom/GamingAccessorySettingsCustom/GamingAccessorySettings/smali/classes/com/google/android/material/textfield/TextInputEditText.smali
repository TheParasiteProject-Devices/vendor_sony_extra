...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    const v1, 0x7f03014f    # @attr/editTextStyle
    ...
    invoke-direct {p0, v2, p2, v1}, Landroidx/appcompat/widget/j;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V

    new-instance v2, Landroid/graphics/Rect;

    invoke-direct {v2}, Landroid/graphics/Rect;-><init>()V

    iput-object v2, p0, Lcom/google/android/material/textfield/TextInputEditText;->l:Landroid/graphics/Rect;

    sget-object v2, Lg4/a;->A:[I

    new-array v8, v0, [I

    const v9, 0x7f0f02f8    # @style/Widget.Design.TextInputEditText

    .line 2
    invoke-static {p1, p2, v1, v9}, Lw4/k;->a(Landroid/content/Context;Landroid/util/AttributeSet;II)V

    const v7, 0x7f0f02f8    # @style/Widget.Design.TextInputEditText

    const v6, 0x7f03014f    # @attr/editTextStyle
    ...
    invoke-static/range {v3 .. v8}, Lw4/k;->b(Landroid/content/Context;Landroid/util/AttributeSet;[III[I)V
...
.method public getFocusedRect(Landroid/graphics/Rect;)V
    ...
    iget-object p0, p0, Lcom/google/android/material/textfield/TextInputEditText;->l:Landroid/graphics/Rect;
...
.method public getGlobalVisibleRect(Landroid/graphics/Rect;Landroid/graphics/Point;)Z
    ...
    iget-boolean v2, p0, Lcom/google/android/material/textfield/TextInputEditText;->m:Z

    if-eqz v2, :cond_0

    if-eqz p1, :cond_0

    iget-object v2, p0, Lcom/google/android/material/textfield/TextInputEditText;->l:Landroid/graphics/Rect;
...
.method public requestRectangleOnScreen(Landroid/graphics/Rect;)Z
    ...
    const v5, 0x7f0601bd    # @dimen/mtrl_edittext_rectangle_top_offset '12.0dp'
