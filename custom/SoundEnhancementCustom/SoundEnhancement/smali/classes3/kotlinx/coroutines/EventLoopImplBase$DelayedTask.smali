...
.method public final declared-synchronized scheduleTask(JLkotlinx/coroutines/EventLoopImplBase$DelayedTaskQueue;Lkotlinx/coroutines/EventLoopImplBase;)I
    ...
    .local v9, "firstTask":Lkotlinx/coroutines/EventLoopImplBase$DelayedTask;
    const/4 v10, 0x0

    .line 445
    .local v10, "$i$a$-addLastIf-EventLoopImplBase$DelayedTask$scheduleTask$1":I
    ...
    .end local v9    # "firstTask":Lkotlinx/coroutines/EventLoopImplBase$DelayedTask;
    .end local v10    # "$i$a$-addLastIf-EventLoopImplBase$DelayedTask$scheduleTask$1":I
    :try_start_3
    monitor-exit v6
    :try_end_3
    ...
    .restart local v9    # "firstTask":Lkotlinx/coroutines/EventLoopImplBase$DelayedTask;
    .restart local v10    # "$i$a$-addLastIf-EventLoopImplBase$DelayedTask$scheduleTask$1":I
    :cond_1
    ...
    .line 465
    :cond_2
    iget-wide v13, v9, Lkotlinx/coroutines/EventLoopImplBase$DelayedTask;->nanoTime:J
    ...
    .line 469
    .local v17, "minTime":J
    iget-wide v11, v4, Lkotlinx/coroutines/EventLoopImplBase$DelayedTaskQueue;->timeNow:J

    move-wide/from16 v2, v17

    .end local v17    # "minTime":J
    .local v2, "minTime":J
    sub-long v17, v2, v11
    ...
    invoke-virtual {v6, v2}, Lkotlinx/coroutines/internal/ThreadSafeHeap;->addImpl(Lkotlinx/coroutines/internal/ThreadSafeHeapNode;)V
    :try_end_4
