...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    const v0, 0x7f03010d    # @attr/toolbarStyle
    ...
    iput-object v2, p0, Landroidx/appcompat/widget/Toolbar;->D:Ljava/util/ArrayList;

    new-instance v2, Ljava/util/ArrayList;

    invoke-direct {v2}, Ljava/util/ArrayList;-><init>()V

    iput-object v2, p0, Landroidx/appcompat/widget/Toolbar;->E:Ljava/util/ArrayList;

    const/4 v2, 0x2

    new-array v3, v2, [I

    iput-object v3, p0, Landroidx/appcompat/widget/Toolbar;->F:[I

    new-instance v3, Lx/f;

    invoke-direct {v3}, Lx/f;-><init>()V

    iput-object v3, p0, Landroidx/appcompat/widget/Toolbar;->G:Lx/f;

    new-instance v3, Ljava/util/ArrayList;

    invoke-direct {v3}, Ljava/util/ArrayList;-><init>()V

    iput-object v3, p0, Landroidx/appcompat/widget/Toolbar;->H:Ljava/util/ArrayList;

    new-instance v3, Landroidx/appcompat/widget/Toolbar$a;

    invoke-direct {v3, p0}, Landroidx/appcompat/widget/Toolbar$a;-><init>(Landroidx/appcompat/widget/Toolbar;)V

    iput-object v3, p0, Landroidx/appcompat/widget/Toolbar;->I:Landroidx/appcompat/widget/Toolbar$a;

    new-instance v3, Landroidx/appcompat/widget/Toolbar$b;

    invoke-direct {v3, p0}, Landroidx/appcompat/widget/Toolbar$b;-><init>(Landroidx/appcompat/widget/Toolbar;)V

    iput-object v3, p0, Landroidx/appcompat/widget/Toolbar;->P:Landroidx/appcompat/widget/Toolbar$b;

    invoke-virtual {p0}, Landroid/view/View;->getContext()Landroid/content/Context;

    move-result-object v3

    sget-object v6, La2/b;->w:[I

    invoke-static {v3, p2, v6, v0}, Lh/j0;->l(Landroid/content/Context;Landroid/util/AttributeSet;[II)Lh/j0;

    move-result-object v0

    iget-object v8, v0, Lh/j0;->b:Landroid/content/res/TypedArray;

    const/4 v10, 0x0

    sget-object v3, Lx/q;->a:Lx/p;

    const v9, 0x7f03010d    # @attr/toolbarStyle
    ...
    invoke-static/range {v4 .. v10}, Lx/q$i;->c(Landroid/view/View;Landroid/content/Context;[ILandroid/util/AttributeSet;Landroid/content/res/TypedArray;II)V

    const/16 p1, 0x1c

    const/4 p2, 0x0

    invoke-virtual {v0, p1, p2}, Lh/j0;->h(II)I
    ...
    iget-object p1, v0, Lh/j0;->b:Landroid/content/res/TypedArray;
    ...
    invoke-virtual {v0, p1, p2}, Lh/j0;->c(II)I
    ...
    invoke-virtual {v0, v1, p1}, Lh/j0;->c(II)I
    ...
    invoke-virtual {v0, p1, v1}, Lh/j0;->c(II)I
    ...
    invoke-virtual {v0, p1, v1}, Lh/j0;->d(II)I
    ...
    invoke-virtual {v0, v2, v1}, Lh/j0;->c(II)I

    move-result v2

    const/4 v3, 0x7

    invoke-virtual {v0, v3, p2}, Lh/j0;->d(II)I

    move-result v3

    const/16 v4, 0x8

    invoke-virtual {v0, v4, p2}, Lh/j0;->d(II)I

    move-result v4

    iget-object v5, p0, Landroidx/appcompat/widget/Toolbar;->t:Lh/d0;

    if-nez v5, :cond_5

    new-instance v5, Lh/d0;

    invoke-direct {v5}, Lh/d0;-><init>()V

    iput-object v5, p0, Landroidx/appcompat/widget/Toolbar;->t:Lh/d0;

    :cond_5
    iget-object v5, p0, Landroidx/appcompat/widget/Toolbar;->t:Lh/d0;

    iput-boolean p2, v5, Lh/d0;->h:Z

    if-eq v3, v1, :cond_6

    iput v3, v5, Lh/d0;->e:I

    iput v3, v5, Lh/d0;->a:I

    :cond_6
    if-eq v4, v1, :cond_7

    iput v4, v5, Lh/d0;->f:I

    iput v4, v5, Lh/d0;->b:I
    ...
    :cond_8
    invoke-virtual {v5, p1, v2}, Lh/d0;->a(II)V
    ...
    invoke-virtual {v0, p1}, Lh/j0;->e(I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v0, p1}, Lh/j0;->j(I)Ljava/lang/CharSequence;
    ...
    invoke-virtual {v0, p1}, Lh/j0;->k(I)Z

    move-result v1

    if-eqz v1, :cond_10

    invoke-virtual {v0, p1}, Lh/j0;->b(I)Landroid/content/res/ColorStateList;
...
.method public static g(Landroid/view/ViewGroup$LayoutParams;)Landroidx/appcompat/widget/Toolbar$g;
    ...
    invoke-direct {v0, p0}, Landroidx/appcompat/widget/Toolbar$g;-><init>(Lc/a$a;)V
...
.method public static i(Landroid/view/View;)I
    ...
    invoke-static {p0}, Lx/e;->c(Landroid/view/ViewGroup$MarginLayoutParams;)I

    move-result v0

    invoke-static {p0}, Lx/e;->b(Landroid/view/ViewGroup$MarginLayoutParams;)I
...
.method public final c()V
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/Toolbar;->h:Lh/i;
    ...
    const v3, 0x7f03010c    # @attr/toolbarNavigationButtonStyle

    invoke-direct {v0, v1, v2, v3}, Lh/i;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V

    iput-object v0, p0, Landroidx/appcompat/widget/Toolbar;->h:Lh/i;

    iget-object v1, p0, Landroidx/appcompat/widget/Toolbar;->f:Landroid/graphics/drawable/Drawable;

    invoke-virtual {v0, v1}, Lh/i;->setImageDrawable(Landroid/graphics/drawable/Drawable;)V
    ...
    iput v1, v0, Lc/a$a;->a:I

    const/4 v1, 0x2

    iput v1, v0, Landroidx/appcompat/widget/Toolbar$g;->b:I

    iget-object v1, p0, Landroidx/appcompat/widget/Toolbar;->h:Lh/i;
...
.method public final d()V
    ...
    iget-object v1, v0, Landroidx/appcompat/widget/ActionMenuView;->p:Landroidx/appcompat/view/menu/e;
    ...
    iget-object v1, p0, Landroidx/appcompat/widget/Toolbar;->K:Landroidx/appcompat/widget/Toolbar$f;
    ...
    iput-object v1, p0, Landroidx/appcompat/widget/Toolbar;->K:Landroidx/appcompat/widget/Toolbar$f;
...
.method public final e()V
    ...
    iput-object v2, v0, Landroidx/appcompat/widget/ActionMenuView;->t:Landroidx/appcompat/view/menu/h$a;

    iput-object v1, v0, Landroidx/appcompat/widget/ActionMenuView;->u:Landroidx/appcompat/view/menu/e$a;
...
.method public final f()V
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/Toolbar;->d:Lh/i;
    ...
    iput-object v0, p0, Landroidx/appcompat/widget/Toolbar;->d:Lh/i;
    ...
    iget-object p0, p0, Landroidx/appcompat/widget/Toolbar;->d:Lh/i;
...
.method public getCollapseContentDescription()Ljava/lang/CharSequence;
    ...
    iget-object p0, p0, Landroidx/appcompat/widget/Toolbar;->h:Lh/i;
...
.method public getContentInsetEnd()I
    ...
    iget-object p0, p0, Landroidx/appcompat/widget/Toolbar;->t:Lh/d0;

    if-eqz p0, :cond_1

    iget-boolean v0, p0, Lh/d0;->g:Z

    if-eqz v0, :cond_0

    iget p0, p0, Lh/d0;->a:I

    goto :goto_0

    :cond_0
    iget p0, p0, Lh/d0;->b:I
...
.method public getCurrentContentInsetEnd()I
    ...
    iget-object v0, v0, Landroidx/appcompat/widget/ActionMenuView;->p:Landroidx/appcompat/view/menu/e;
...
.method public getLogo()Landroid/graphics/drawable/Drawable;
    ...
    iget-object p0, p0, Landroidx/appcompat/widget/Toolbar;->e:Lh/k;
...
.method public final getSubtitleTextView()Landroid/widget/TextView;
    ...
    iget-object p0, p0, Landroidx/appcompat/widget/Toolbar;->c:Lh/p;
...
.method public final getTitleTextView()Landroid/widget/TextView;
    ...
    iget-object p0, p0, Landroidx/appcompat/widget/Toolbar;->b:Lh/p;

    return-object p0
.end method

.method public getWrapper()Lh/s;
    .locals 1
    ...
    :cond_0
    iget-object p0, p0, Landroidx/appcompat/widget/Toolbar;->J:Landroidx/appcompat/widget/d;
...
.method public final k()V
    ...
    iget-object v1, p0, Landroidx/appcompat/widget/Toolbar;->G:Lx/f;

    iget-object v1, v1, Lx/f;->a:Ljava/util/concurrent/CopyOnWriteArrayList;
...
.method public final onLayout(ZIIII)V
    ...
    invoke-static/range {p0 .. p0}, Lx/q$c;->d(Landroid/view/View;)I
    ...
    invoke-static/range {p0 .. p0}, Lx/q$b;->d(Landroid/view/View;)I
    ...
    :goto_1
    iget-object v13, v0, Landroidx/appcompat/widget/Toolbar;->d:Lh/i;
    ...
    :goto_3
    iget-object v15, v0, Landroidx/appcompat/widget/Toolbar;->h:Lh/i;
    ...
    :cond_9
    :goto_6
    iget-object v13, v0, Landroidx/appcompat/widget/Toolbar;->e:Lh/k;
    ...
    :cond_b
    :goto_7
    iget-object v13, v0, Landroidx/appcompat/widget/Toolbar;->b:Lh/p;

    invoke-virtual {v0, v13}, Landroidx/appcompat/widget/Toolbar;->q(Landroid/view/View;)Z

    move-result v13

    iget-object v14, v0, Landroidx/appcompat/widget/Toolbar;->c:Lh/p;
    ...
    iget-object v15, v0, Landroidx/appcompat/widget/Toolbar;->b:Lh/p;
    ...
    iget-object v7, v0, Landroidx/appcompat/widget/Toolbar;->b:Lh/p;
    ...
    iget-object v3, v0, Landroidx/appcompat/widget/Toolbar;->c:Lh/p;
    ...
    iget-object v4, v0, Landroidx/appcompat/widget/Toolbar;->c:Lh/p;
    ...
    iget-object v3, v0, Landroidx/appcompat/widget/Toolbar;->b:Lh/p;
    ...
    :cond_11
    iget-object v4, v0, Landroidx/appcompat/widget/Toolbar;->b:Lh/p;
    ...
    iget-object v15, v0, Landroidx/appcompat/widget/Toolbar;->c:Lh/p;
    ...
    iget-object v1, v0, Landroidx/appcompat/widget/Toolbar;->b:Lh/p;
    ...
    iget-object v5, v0, Landroidx/appcompat/widget/Toolbar;->b:Lh/p;
    ...
    iget-object v1, v0, Landroidx/appcompat/widget/Toolbar;->c:Lh/p;
    ...
    iget-object v5, v0, Landroidx/appcompat/widget/Toolbar;->c:Lh/p;
...
.method public final onMeasure(II)V
    ...
    invoke-static/range {p0 .. p0}, Lh/o0;->a(Landroid/view/View;)Z

    move-result v6

    xor-int/lit8 v8, v6, 0x1

    iget-object v0, v7, Landroidx/appcompat/widget/Toolbar;->d:Lh/i;
    ...
    iget-object v1, v7, Landroidx/appcompat/widget/Toolbar;->d:Lh/i;
    ...
    iget-object v2, v7, Landroidx/appcompat/widget/Toolbar;->d:Lh/i;
    ...
    :goto_0
    iget-object v0, v7, Landroidx/appcompat/widget/Toolbar;->h:Lh/i;
    ...
    iget-object v1, v7, Landroidx/appcompat/widget/Toolbar;->h:Lh/i;
    ...
    iget-object v2, v7, Landroidx/appcompat/widget/Toolbar;->h:Lh/i;
    ...
    :cond_3
    iget-object v0, v7, Landroidx/appcompat/widget/Toolbar;->e:Lh/k;
    ...
    iget-object v1, v7, Landroidx/appcompat/widget/Toolbar;->e:Lh/k;
    ...
    iget-object v0, v7, Landroidx/appcompat/widget/Toolbar;->b:Lh/p;
    ...
    iget-object v1, v7, Landroidx/appcompat/widget/Toolbar;->b:Lh/p;
    ...
    iget-object v2, v7, Landroidx/appcompat/widget/Toolbar;->b:Lh/p;
    ...
    :goto_4
    iget-object v0, v7, Landroidx/appcompat/widget/Toolbar;->c:Lh/p;
    ...
    iget-object v1, v7, Landroidx/appcompat/widget/Toolbar;->c:Lh/p;
...
.method public final onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    iget-object v2, p0, Landroidx/appcompat/widget/Toolbar;->K:Landroidx/appcompat/widget/Toolbar$f;
...
.method public final onRtlPropertiesChanged(I)V
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/Toolbar;->t:Lh/d0;
    ...
    iput-object v0, p0, Landroidx/appcompat/widget/Toolbar;->t:Lh/d0;
    ...
    :cond_2
    iput-boolean v0, p0, Lh/d0;->g:Z

    iget-boolean p1, p0, Lh/d0;->h:Z
    ...
    :cond_3
    iget v0, p0, Lh/d0;->e:I

    :goto_1
    iput v0, p0, Lh/d0;->a:I

    iget v0, p0, Lh/d0;->c:I
    ...
    :cond_6
    iget p1, p0, Lh/d0;->e:I

    iput p1, p0, Lh/d0;->a:I

    :cond_7
    iget v0, p0, Lh/d0;->f:I

    :goto_3
    iput v0, p0, Lh/d0;->b:I
...
.method public final onSaveInstanceState()Landroid/os/Parcelable;
    ...
    iget-object v1, v1, Landroidx/appcompat/widget/Toolbar$f;->b:Landroidx/appcompat/view/menu/f;
...
.method public final r()V
    ...
    iget-object v1, p0, Landroidx/appcompat/widget/Toolbar;->N:Landroid/window/OnBackInvokedDispatcher;
    ...
    invoke-direct {v1, p0, v2}, Lh/k0;-><init>(Landroidx/appcompat/widget/Toolbar;I)V
...
.method public setCollapseIcon(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-virtual {p0, p1}, Lh/i;->setImageDrawable(Landroid/graphics/drawable/Drawable;)V

    goto :goto_0

    :cond_0
    iget-object p1, p0, Landroidx/appcompat/widget/Toolbar;->h:Lh/i;

    if-eqz p1, :cond_1

    iget-object p0, p0, Landroidx/appcompat/widget/Toolbar;->f:Landroid/graphics/drawable/Drawable;

    invoke-virtual {p1, p0}, Lh/i;->setImageDrawable(Landroid/graphics/drawable/Drawable;)V
...
.method public setLogo(Landroid/graphics/drawable/Drawable;)V
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/Toolbar;->e:Lh/k;
    ...
    iput-object v0, p0, Landroidx/appcompat/widget/Toolbar;->e:Lh/k;
    ...
    iget-object v1, p0, Landroidx/appcompat/widget/Toolbar;->e:Lh/k;
    ...
    invoke-virtual {p0, p1}, Lh/k;->setImageDrawable(Landroid/graphics/drawable/Drawable;)V
...
.method public setNavigationContentDescription(Ljava/lang/CharSequence;)V
    ...
    invoke-static {p0, p1}, Lh/m0;->a(Landroid/view/View;Ljava/lang/CharSequence;)V
...
.method public setNavigationIcon(Landroid/graphics/drawable/Drawable;)V
    ...
    iget-object v1, p0, Landroidx/appcompat/widget/Toolbar;->d:Lh/i;
...
.method public setSubtitle(Ljava/lang/CharSequence;)V
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/Toolbar;->c:Lh/p;
    ...
    invoke-direct {v1, v0, v2}, Lh/p;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V

    iput-object v1, p0, Landroidx/appcompat/widget/Toolbar;->c:Lh/p;

    invoke-virtual {v1}, Landroid/widget/TextView;->setSingleLine()V

    iget-object v1, p0, Landroidx/appcompat/widget/Toolbar;->c:Lh/p;
    ...
    iget-object v2, p0, Landroidx/appcompat/widget/Toolbar;->c:Lh/p;

    invoke-virtual {v2, v0, v1}, Lh/p;->setTextAppearance(Landroid/content/Context;I)V
...
.method public setTitle(Ljava/lang/CharSequence;)V
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/Toolbar;->b:Lh/p;
    ...
    iput-object v1, p0, Landroidx/appcompat/widget/Toolbar;->b:Lh/p;

    invoke-virtual {v1}, Landroid/widget/TextView;->setSingleLine()V

    iget-object v1, p0, Landroidx/appcompat/widget/Toolbar;->b:Lh/p;
    ...
    iget-object v2, p0, Landroidx/appcompat/widget/Toolbar;->b:Lh/p;
