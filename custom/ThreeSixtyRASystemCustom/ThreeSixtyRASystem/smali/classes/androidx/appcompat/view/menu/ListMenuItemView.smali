...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    sget-object v1, La2/b;->r:[I

    const v2, 0x7f0300a6    # @attr/listMenuViewStyle

    invoke-static {v0, p2, v1, v2}, Lh/j0;->l(Landroid/content/Context;Landroid/util/AttributeSet;[II)Lh/j0;

    move-result-object p2

    const/4 v0, 0x5

    invoke-virtual {p2, v0}, Lh/j0;->e(I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {p2, v1, v0}, Lh/j0;->h(II)I
    ...
    invoke-virtual {p2, v0, v2}, Lh/j0;->a(IZ)Z
...
.method public final b(Landroidx/appcompat/view/menu/f;)V
    ...
    iput-object p1, p0, Landroidx/appcompat/view/menu/ListMenuItemView;->a:Landroidx/appcompat/view/menu/f;
    ...
    iget-char v3, p1, Landroidx/appcompat/view/menu/f;->j:C

    goto :goto_1

    :cond_1
    iget-char v3, p1, Landroidx/appcompat/view/menu/f;->h:C
    ...
    iget-object v0, p0, Landroidx/appcompat/view/menu/ListMenuItemView;->a:Landroidx/appcompat/view/menu/f;
    ...
    iget-object v3, p0, Landroidx/appcompat/view/menu/ListMenuItemView;->a:Landroidx/appcompat/view/menu/f;

    iget-object v5, v3, Landroidx/appcompat/view/menu/f;->n:Landroidx/appcompat/view/menu/e;
    ...
    iget-char v5, v3, Landroidx/appcompat/view/menu/f;->j:C

    goto :goto_6

    :cond_6
    iget-char v5, v3, Landroidx/appcompat/view/menu/f;->h:C
    ...
    :cond_7
    iget-object v6, v3, Landroidx/appcompat/view/menu/f;->n:Landroidx/appcompat/view/menu/e;

    iget-object v7, v6, Landroidx/appcompat/view/menu/e;->a:Landroid/content/Context;
    ...
    iget-object v9, v6, Landroidx/appcompat/view/menu/e;->a:Landroid/content/Context;
    ...
    const v9, 0x7f0e0012    # @string/abc_prepend_shortcut_label 'Menu+'
    ...
    :cond_8
    invoke-virtual {v6}, Landroidx/appcompat/view/menu/e;->m()Z

    move-result v6

    if-eqz v6, :cond_9

    iget v3, v3, Landroidx/appcompat/view/menu/f;->k:I

    goto :goto_7

    :cond_9
    iget v3, v3, Landroidx/appcompat/view/menu/f;->i:I

    :goto_7
    const v6, 0x7f0e000e    # @string/abc_menu_meta_shortcut_label 'Meta+'
    ...
    invoke-static {v8, v3, v9, v6}, Landroidx/appcompat/view/menu/f;->c(Ljava/lang/StringBuilder;IILjava/lang/String;)V

    const v6, 0x7f0e000a    # @string/abc_menu_ctrl_shortcut_label 'Ctrl+'
    ...
    const v6, 0x7f0e0009    # @string/abc_menu_alt_shortcut_label 'Alt+'
    ...
    const v6, 0x7f0e000f    # @string/abc_menu_shift_shortcut_label 'Shift+'

    invoke-virtual {v7, v6}, Landroid/content/res/Resources;->getString(I)Ljava/lang/String;

    move-result-object v6

    invoke-static {v8, v3, v4, v6}, Landroidx/appcompat/view/menu/f;->c(Ljava/lang/StringBuilder;IILjava/lang/String;)V

    const v4, 0x7f0e0011    # @string/abc_menu_sym_shortcut_label 'Sym+'
    ...
    invoke-static {v8, v3, v6, v4}, Landroidx/appcompat/view/menu/f;->c(Ljava/lang/StringBuilder;IILjava/lang/String;)V

    const v4, 0x7f0e000d    # @string/abc_menu_function_shortcut_label 'Function+'

    invoke-virtual {v7, v4}, Landroid/content/res/Resources;->getString(I)Ljava/lang/String;

    move-result-object v4

    invoke-static {v8, v3, v2, v4}, Landroidx/appcompat/view/menu/f;->c(Ljava/lang/StringBuilder;IILjava/lang/String;)V
    ...
    :cond_a
    const v2, 0x7f0e0010    # @string/abc_menu_space_shortcut_label 'space'

    goto :goto_8

    :cond_b
    const v2, 0x7f0e000c    # @string/abc_menu_enter_shortcut_label 'enter'

    goto :goto_8

    :cond_c
    const v2, 0x7f0e000b    # @string/abc_menu_delete_shortcut_label 'delete'
...
.method public getItemData()Landroidx/appcompat/view/menu/f;
    ...
    iget-object p0, p0, Landroidx/appcompat/view/menu/ListMenuItemView;->a:Landroidx/appcompat/view/menu/f;
...
.method public final onFinishInflate()V
    ...
    :cond_0
    const v0, 0x7f080082    # @id/shortcut
    ...
    const v0, 0x7f08008c    # @id/submenuarrow
    ...
    :cond_1
    const v0, 0x7f080055    # @id/group_divider
    ...
    const v0, 0x7f080047    # @id/content
...
.method public setCheckable(Z)V
    ...
    const v3, 0x7f0b0011    # @layout/abc_list_menu_item_radio 'res/layout/abc_list_menu_item_radio.xml'
    ...
    const v3, 0x7f0b000e    # @layout/abc_list_menu_item_checkbox 'res/layout/abc_list_menu_item_checkbox.xml'
    ...
    invoke-virtual {p0}, Landroidx/appcompat/view/menu/f;->isChecked()Z
