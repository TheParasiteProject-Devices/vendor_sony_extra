...
.method private static compositeThumbAndIconDrawable(Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
    ...
    .line 394
    .local v1, "iconNewWidth":I
    invoke-virtual {p1}, Landroid/graphics/drawable/Drawable;->getIntrinsicHeight()I

    move-result v2

    .local v2, "iconNewHeight":I
    goto :goto_0

    .line 396
    .end local v1    # "iconNewWidth":I
    .end local v2    # "iconNewHeight":I
    :cond_2
    nop
    ...
    invoke-virtual {v0, v3, v1, v2}, Landroid/graphics/drawable/LayerDrawable;->setLayerSize(III)V

    .line 414
    const/16 v4, 0x11

    invoke-virtual {v0, v3, v4}, Landroid/graphics/drawable/LayerDrawable;->setLayerGravity(II)V
