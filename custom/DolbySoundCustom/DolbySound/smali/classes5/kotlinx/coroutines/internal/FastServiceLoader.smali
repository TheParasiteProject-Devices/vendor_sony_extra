...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "loadMainDispatcherFactory$external__kotlinx_coroutines__android_common__kotlinx_coroutines",
        "loadProviders",
        "loadProviders$external__kotlinx_coroutines__android_common__kotlinx_coroutines",
        "parse",
        "url",
        "Ljava/net/URL;",
        "parseFile",
...
.method private final load(Ljava/lang/Class;Ljava/lang/ClassLoader;)Ljava/util/List;
    ...
    .line 87
    :try_start_0
    invoke-virtual {p0, p1, p2}, Lkotlinx/coroutines/internal/FastServiceLoader;->loadProviders$external__kotlinx_coroutines__android_common__kotlinx_coroutines(Ljava/lang/Class;Ljava/lang/ClassLoader;)Ljava/util/List;
    ...
    const-string v2, "load(service, loader)"
...
# virtual methods
.method public final loadMainDispatcherFactory$external__kotlinx_coroutines__android_common__kotlinx_coroutines()Ljava/util/List;
    .locals 12
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    .line 162
    .local v5, "$i$f$createInstanceOf":I
    nop
    ...
    invoke-static {v3, v7, v9}, Ljava/lang/Class;->forName(Ljava/lang/String;ZLjava/lang/ClassLoader;)Ljava/lang/Class;

    move-result-object v9

    .line 164
    .local v9, "clz$iv":Ljava/lang/Class;
    ...
    .end local v9    # "clz$iv":Ljava/lang/Class;
    ...
    .line 166
    .local v9, "e$iv":Ljava/lang/ClassNotFoundException;
    move-object v10, v6

    .line 162
    .end local v9    # "e$iv":Ljava/lang/ClassNotFoundException;
    :goto_0
    nop
    ...
    .end local v5    # "$i$f$createInstanceOf":I
    if-eqz v10, :cond_1
    ...
    .line 168
    .restart local v5    # "$i$f$createInstanceOf":I
    nop
    ...
    .line 170
    .local v7, "clz$iv":Ljava/lang/Class;
    ...
    .end local v7    # "clz$iv":Ljava/lang/Class;
    ...
    .line 172
    .local v7, "e$iv":Ljava/lang/ClassNotFoundException;
    nop

    .line 168
    .end local v7    # "e$iv":Ljava/lang/ClassNotFoundException;
    :goto_1
    nop
    ...
    .line 167
    .local v3, "$this$loadMainDispatcherFactory_u24lambda_u241":Lkotlinx/coroutines/internal/MainDispatcherFactory;
    const/4 v4, 0x0

    .line 61
    .local v4, "$i$a$-apply-FastServiceLoader$loadMainDispatcherFactory$2":I
    :try_start_4
    invoke-virtual {v1, v3}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    .line 62
    .end local v3    # "$this$loadMainDispatcherFactory_u24lambda_u241":Lkotlinx/coroutines/internal/MainDispatcherFactory;
    .end local v4    # "$i$a$-apply-FastServiceLoader$loadMainDispatcherFactory$2":I
    :cond_2
    nop
...
.method public final loadProviders$external__kotlinx_coroutines__android_common__kotlinx_coroutines(Ljava/lang/Class;Ljava/lang/ClassLoader;)Ljava/util/List;
    .locals 13
    .param p1, "service"    # Ljava/lang/Class;
    .param p2, "loader"    # Ljava/lang/ClassLoader;
    .annotation system Ldalvik/annotation/Signature;
